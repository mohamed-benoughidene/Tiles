    ...
    return (
        <>
            <motion.div
                ...
                className={cn(
                    "relative rounded-[2rem] h-full transition-colors duration-200 cursor-grab active:cursor-grabbing group bento-tile-content",
                    isSelected
                        ? cn(
                            "ring-4 ring-indigo-500/10 dark:ring-indigo-500/20 border-2 border-indigo-500/50 dark:border-indigo-500 z-20",
                            tile.type === 'placeholder' ? "bg-transparent" : "bg-white dark:bg-zinc-900"
                        )
            ...
            >
                ...
                >
                    ...
                    <button className="w-7 h-7 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 rounded-md flex items-center justify-center hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors cursor-grab">
                    ...
                    {/* Size Options */}
                    {(Object.values(TILE_SIZES) as TileSize[]).map((size) => (
                        <button
                            key={size.name}
                            onClick={(e) => {
                                e.stopPropagation();
