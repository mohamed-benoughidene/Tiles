...
export function TextTile({ id = '', title = 'Header', onRemove }: TextTileProps) {
    ...
    const handlePointerUp = (e: React.PointerEvent) => {
        ...
        // We remove the time check to allow slower clicks/holds that don't move to still trigger edit.
        // Dragging (moving > 10px) will still be skipped.
