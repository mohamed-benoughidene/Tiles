...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default:
                    "bg-primary text-white shadow-lg shadow-primary/25 hover:bg-primary/90 hover:scale-[1.02]",
                destructive:
                ...
                link: "text-zinc-600 dark:text-zinc-300 hover:text-primary dark:hover:text-white underline-offset-4 hover:underline",
            },
            size: {
                default: "h-12 px-6 py-2 text-base font-bold tracking-tight rounded-lg",
